...
export interface RawDuplicateDependencyPluginOptions {
  onDetected?: (response: JsDuplicateDependencyPluginResponse) => void
}
...
export declare const enum BuiltinPluginName {
...
export declare const enum JsLoaderState {
  Pitching = 'Pitching',
  Normal = 'Normal'
}
...
export declare const enum JsRspackSeverity {
  Error = 'Error',
  Warn = 'Warn'
}
...
export declare const enum RawRuleSetConditionType {
  string = 'string',
  regexp = 'regexp',
  logical = 'logical',
  array = 'array',
...
export declare const enum RegisterJsTapKind {
